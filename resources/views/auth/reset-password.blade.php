<x-guest-layout>
    <form method="POST" action="{{ route('password.store') }}" class="space-y-4">
        ...
        <div>
            <label for="password" class="block text-sm font-bold text-[#4A3018] mb-1.5">Sandi Baru</label>
        ...
        <div>
            <label for="password_confirmation" class="block text-sm font-bold text-[#4A3018] mb-1.5">Konfirmasi Sandi Baru</label>
